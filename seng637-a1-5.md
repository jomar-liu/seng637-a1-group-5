...
The exploratory testing phase was structured around the idea of actively exploring different transaction functionalities within the ATM system. We freely explored the system's behavior with minimal guidelines, which allowed for a broad coverage of the system's features, ranging from basic operations like withdrawals, fund transfers, balance inquiries, and deposits to more complex scenarios like handling invalid card entries. Pair testing was performed, with each pair assigned to a specific area to focus on, ensuring a wide spread of testing across the ATM system.

## Test Types

Pair testing was conducted, and the 4 members were split into 2 pairs. Within a pair, one person performed the testing, the other reviewed and analyzed the results, and reported bugs to Jira. 

The general approach was to test most functions, and both common and exceptional paths (e.g., huge deposit amount, very long card pin) were taken. 
...
The SUT was tested by 4 testers, other than the developers.
...
![Bug A1G5-25: withdrawal instead of balance inquiry](transaction_log_bugA1G5-25.jpg) 

# How the pair testing was managed and team work/effort was divided 

The team was divided into two pairs, with four members in total. Within each pair, one member conducted the testing while the other reviewed and analyzed the results. Peer reviews were conducted to evaluate defect reports. Regression testing was conducted individually, with each member responsible for a similar number of defects reported and scripted test cases to ensure an even distribution of effort.
...
Additionally, we discovered that the various functions of the ATM system, such as withdrawal, deposit, transfers, and balance inquiry, are interconnected. The defects we identified provided insight into how these functions depend on one another, and how an issue in one can impact the overall performance of the system.
